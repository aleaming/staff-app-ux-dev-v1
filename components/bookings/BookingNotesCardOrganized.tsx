...
/**
 * BookingNotesCardOrganized.tsx
 * 
 * This is the organized/structured version of the Field Staff Notes card.
 * It parses and displays notes in organized sections (entry codes, guest info, etc.)
 * 
 * PRESERVED FOR FUTURE USE when backend provides structured note data.
 * Currently not in use - see BookingNotesCard.tsx for the active simple version.
 */
...
interface BookingNotesCardOrganizedProps {
  notes: BookingNotes
}

export function BookingNotesCardOrganized({ notes }: BookingNotesCardOrganizedProps) {
